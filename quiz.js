(function () {
    const QUESTIONS = window.QUESTIONS_CH1 || [];
    const RUN_SIZE = 12;
    ...
    function newRun() {
        ...
        const picked = shuffle(QUESTIONS).slice(0, RUN_SIZE).map(q => ({
            id: q.id,
            picked: null,
        }));
    ...
    function submit() {
      ...
      <p class="muted" style="margin-top:8px">
        Review aufmachen, falsche Fragen markieren, danach direkt neuer Run. So baust du klausursichere Trefferquote.
      </p>
    `;
    ...
    function showReview() {
      ...
      <div class="question">
        <div class="row space">
          <p class="q-title" style="margin:0">${i + 1}. ${d.q}</p>
